...
##########################
# 1. Accept user code
# 2. We don't need output of user
# 3. Accept user email
# 4. Accept user UUID
# 5. Before everything add question with test cases in the DB
# 6. After the user submits code, run the code and check for input output test cases
# 7. If all cases pass, send pass otherwise send fail in the backend api
